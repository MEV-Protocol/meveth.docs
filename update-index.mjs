 ...
 */
const indexes = JSON.parse(readFileSync(resolve('./.next/_map_indexes.json')).toString());

const client = algosearch(process.env.ALGOLIA_APP_ID, process.env.ALGOLIA_API_KEY);
